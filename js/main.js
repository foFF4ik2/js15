...
console.log(myPow(3, 4, myPrint)); // 3^4=81
console.log(myPow(2, 10, myPrint)); // 2^10=1024
 ...
 */
console.log('--------');
let list = [545, 12, 23, 100, 34, 56, 9, 233];
let myMax = (arg) => Math.max.apply(Math, arg);
console.log(myMax(list)); // 545
...
let notUniqNums = [1, 2, 3, 2, 1, 8, 1, 5, 4, 6, 7];
let notUniqStrings = [
  'Bob',
  'Kate',
  'John',
